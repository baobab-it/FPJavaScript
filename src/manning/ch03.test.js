...
describe("Chapter 3", function() {
    ...
    test("Tree navigation", function() {
        ...
        const constable = new Node(
            new Person("123-23-6778", "Robert", "Constable")
        );
        const mendelson = new Node(
            new Person("123-23-3454", "Elliot", "Mendelson")
        );
